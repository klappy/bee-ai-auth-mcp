...
6. Add the Worker URL as a custom connector in your MCP client, approve the GitHub login, then **pair your Bee at the consent screen** and run `whoami` (or `bee_docs` / `bee_read`).
