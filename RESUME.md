...
**Deploy model:** Workers Builds auto-deploys. Live `bee.klappy.dev/version` tracks branch `production`, not merge-to-`main` (issue #37). Branch pushes run `versions upload` and do **not** get a Preview URL (Durable Object + Container). No seat `wrangler deploy`. See `docs/ci-cd.md`.
